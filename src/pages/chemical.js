...
function Chemical({ subjects}) {
  return (
    <>
     
        <Navbar/>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-center text-3xl font-bold leading-tight text-gray-900 mb-6 p-4">CHEMICAL Subjects</h1>
